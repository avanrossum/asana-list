...
const electronAPI: ElectronAPI = {
  ...
  getProjectDetail: (projectGid) => ipcRenderer.invoke('asana:get-project-detail', projectGid),
  getSectionTasks: (sectionGid) => ipcRenderer.invoke('asana:get-section-tasks', sectionGid),
